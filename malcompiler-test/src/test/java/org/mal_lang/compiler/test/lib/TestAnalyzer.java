...
public class TestAnalyzer extends MalTest {
  ...
  public void testBad1() {
    ...
    String[] expected = {
      ...
      "[ANALYZER WARNING] <bad1.mal:21:7> Step 'c' defined as variable at <bad1.mal:19:11> and field at <bad1.mal:47:26>",
      ...
      "[ANALYZER ERROR] <bad1.mal:24:8> Types '_C' and '_A' have no common ancestor",
      "[ANALYZER ERROR] <bad1.mal:25:7> Asset '_C' cannot be of type '_A'",
      "[ANALYZER WARNING] <bad1.mal:27:18> Asset 'AA' is abstract but never extended to",
      "[ANALYZER ERROR] <bad1.mal:28:7> Cannot override attack step 'compromise' previously defined at <bad1.mal:18:7> with different type 'ALL' =/= 'ANY'",
      "[ANALYZER ERROR] <bad1.mal:29:14> Cannot inherit attack step 'access' without previous definition",
      "[ANALYZER ERROR] <bad1.mal:30:7> Attack step 'authorize' not defined for asset 'AA'",
      "[ANALYZER ERROR] <bad1.mal:31:7> Field 'b' not defined for asset 'AA'",
      "[ANALYZER ERROR] <bad1.mal:33:9> Asset 'AA' previously defined at <bad1.mal:27:18>",
      "[ANALYZER ERROR] <bad1.mal:36:9> Variable 'var1' previously defined at <bad1.mal:35:9>",
      "[ANALYZER WARNING] <bad1.mal:37:7> Attack step _C.compromise contains duplicate classification {C}",
      "[ANALYZER ERROR] <bad1.mal:39:11> Variable 'aaa' previously defined at <bad1.mal:38:11>",
      "[ANALYZER ERROR] <bad1.mal:40:7> Attack step 'var1' not defined for asset '_C'",
      "[ANALYZER ERROR] <bad1.mal:41:7> Previous asset '_C' is not of type '_A'",
      "[ANALYZER ERROR] <bad1.mal:42:7> Defenses cannot have CIA classifications",
      "[ANALYZER ERROR] <bad1.mal:48:7> Field _A.a previously defined at <bad1.mal:48:26>",
      "[ANALYZER ERROR] <bad1.mal:50:6> Metadata 'assumptions' previously defined at <bad1.mal:49:6>",
      ""
    };
