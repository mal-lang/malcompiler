...
public class TestAllFeatures extends MalTest {
  ...
  public void testLexerCore() {
    Token[] tokens = {
      ...
      new Token(TokenType.ASSUMPTIONS, CORE_MAL, 79, 3),
      new Token(TokenType.COLON, CORE_MAL, 79, 14),
      new Token(TokenType.STRING, CORE_MAL, 79, 16, "None for C2"),
      ...
      new Token(TokenType.ASSUMPTIONS, CORE_MAL, 82, 5),
      new Token(TokenType.COLON, CORE_MAL, 82, 16),
      new Token(TokenType.STRING, CORE_MAL, 82, 18, "None for A4"),
      new Token(TokenType.RATIONALE, CORE_MAL, 83, 5),
      new Token(TokenType.COLON, CORE_MAL, 83, 14),
      new Token(TokenType.STRING, CORE_MAL, 83, 16, "Reasoning for A4"),
      new Token(TokenType.INFO, CORE_MAL, 84, 5),
      new Token(TokenType.COLON, CORE_MAL, 84, 9),
      new Token(TokenType.STRING, CORE_MAL, 84, 11, "This is A4"),
      ...
      new Token(TokenType.RATIONALE, CORE_MAL, 94, 3),
      new Token(TokenType.COLON, CORE_MAL, 94, 12),
      new Token(TokenType.STRING, CORE_MAL, 94, 14, "Reasoning for C2"),
      ...
      new Token(TokenType.ASSUMPTIONS, CORE_MAL, 97, 5),
      new Token(TokenType.COLON, CORE_MAL, 97, 16),
      new Token(TokenType.STRING, CORE_MAL, 97, 18, "None for A5"),
      ...
      new Token(TokenType.RATIONALE, CORE_MAL, 101, 5),
      new Token(TokenType.COLON, CORE_MAL, 101, 14),
      new Token(TokenType.STRING, CORE_MAL, 101, 16, "Reasoning for A6"),
  ...
  public void testParser() {
    ...
    assertCategory(
        new AST.Category(
            ...
            Arrays.asList(
                new AST.Meta(
                    new Position(CORE_MAL, 79, 3), AST.MetaType.ASSUMPTIONS, "None for C2")),
            Arrays.asList(
                new AST.Asset(
                    ...
                    Arrays.asList(
                        new AST.Meta(
                            new Position(CORE_MAL, 82, 5), AST.MetaType.ASSUMPTIONS, "None for A4"),
                        new AST.Meta(
                            new Position(CORE_MAL, 83, 5),
                            AST.MetaType.RATIONALE,
                            "Reasoning for A4"),
                        new AST.Meta(
                            new Position(CORE_MAL, 84, 5), AST.MetaType.INFO, "This is A4")),
                    Arrays.asList(
                        new AST.AttackStep(
    ...
    assertCategory(
        new AST.Category(
            ...
            Arrays.asList(
                new AST.Meta(
                    new Position(CORE_MAL, 94, 3), AST.MetaType.RATIONALE, "Reasoning for C2")),
            Arrays.asList(
                new AST.Asset(
